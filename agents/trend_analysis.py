"""Trend analysis agent: trend and period-over-period performance comparisons."""
from core.llm_client import generate
from tools.csv_reader import load_dataframe

TREND_ANALYSIS_PROMPT = """You are a financial trend analysis agent. Analyze the data below to answer
...
def run_trend_analysis(filepath: str, question: str, preferences: list[str] | None = None) -> str:
